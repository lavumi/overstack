...
1. 랜딩 화면에서 시작한다.
2. 캐릭터 빌더에서 시작 trait, 시작 스킬, 스탯을 정한다.
...
- `Basic Attack`은 항상 사용할 수 있습니다.
- 그 외 시작 스킬은 빌더에서 예산 안에 직접 고릅니다.
- 고른 시작 스킬만 전투 시작 시 슬롯에 들어옵니다.
- 고르지 않은 스킬 슬롯은 `Empty`로 표시되며 사용할 수 없습니다.
